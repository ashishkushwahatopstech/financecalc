...
export const PRODUCTIVITY_GROUP = [
  ...
  { name: 'YouTube Tools', href: 'youtube-tools.html', desc: 'Grab thumbnails, extract tags & suggestions', icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2" d="M15 10l-6 4V10l6 4zm5.7-4.3c-.7-.7-1.8-1-2.9-1H6.2c-1.1 0-2.2.3-2.9 1a3.8 3.8 0 00-1 2.9v6.8c0 1.1.3 2.2 1 2.9a4.2 4.2 0 002.9 1H17.8c1.1 0 2.2-.3 2.9-1a4 4 0 001-2.9V8.6a4.2 4.2 0 00-1-2.9z"></path>', color: 'rose' }
];
