      ...
      <div class="p-4 space-y-4 flex-1 overflow-y-auto">
        ...
        <div>
          ...
          <div class="grid grid-cols-3 gap-2">
            ...
            <a href="updates.html" class="flex flex-col items-center justify-center p-3 ${
              isBlogActive 
                ? 'bg-rose-100 border-rose-300 text-rose-950 font-black shadow-sm' 
                : 'bg-rose-50/50 border-rose-200/80 text-rose-700 hover:bg-rose-100/80 hover:text-rose-900 hover:scale-105 active:scale-95 duration-300'
            } rounded-xl transition-all border text-center gap-1.5 cursor-pointer">
              <svg class="w-5 h-5 text-rose-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path></svg>
              <span class="text-[10px] font-bold">Blog</span>
            </a>
            ${isAdmin ? `
              <a href="admin.html" class="col-span-3 flex items-center justify-center gap-2 p-2.5 bg-amber-50 hover:bg-amber-100 text-amber-900 font-bold text-xs rounded-xl transition-colors border border-amber-200">
                <svg class="w-4 h-4 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                Admin Dashboard
              </a>
            ` : ''}
